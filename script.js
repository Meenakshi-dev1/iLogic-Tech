(function() {
  ...
  function refineAboutContent() {
    ...
    aboutColumn.innerHTML = '<article class="glass about-feature-panel">' +
      ...
      '<p class="lead" style= "text-align: justify; font-family:timesnewroman;">iLogic Tech delivers comprehensive technology solutions designed to accelerate business growth and digital transformation. From advanced POS systems and custom software development to Artificial Intelligence (AI), cybersecurity, networking infrastructure, and IT consulting, we help organizations improve efficiency, security, and performance.</p>' +
      '<p class="lead" style= "text-align: justify; font-family:timesnewroman;">As an official LanguageCert partner, we also provide globally recognized English certification programs, empowering businesses and individuals across Singapore, India, Kuwait, and Ireland with innovative technology and professional development opportunities.</p>' +
      ...
      '<div class="about-detail-media"><img src="' + aboutInfrastructureImage + '" alt="Networking, Infrastructure and Training" loading="lazy" /></div>' +
      '<div class="about-detail-copy"><h3>Networking, Infrastructure & Training</h3><p class="muted" style= "text-align: justify;">Build a secure, scalable, and future-ready IT environment with our networking, cybersecurity, and professional training solutions. We help businesses strengthen their technology infrastructure, enhance security, and develop skilled talent to support long-term growth and operational resilience.</p>' +
