(function() {
  ...
  function refineAboutContent() {
    ...
    aboutColumn.innerHTML = '<article class="glass about-feature-panel">' +
      ...
      '<p class="lead" style="text-align:justify; font-family:timesnewroman;">Build a secure, scalable, and future-ready IT environment with our networking, infrastructure, and cybersecurity solutions designed to enhance security, optimize performance, and support long-term business growth and operational resilience.</p>' +      
